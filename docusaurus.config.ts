...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/TryHackMyOffsecBox/TryHackMe-CN/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Github - TryHackMyOffsecBox',
              href: 'https://github.com/TryHackMyOffsecBox',
            },
            {
              label: 'Github - CRONUS-Security',
              href: 'https://github.com/CRONUS-Security',
            },
          ],
        },
        // {
    ...
    prism: {
      additionalLanguages: ['powershell', 'php', 'ini', 'json', 'docker', 'java', 'csharp', 'bash'],
