...
| Docker镜像 |           标签          |                                          命令示例                                          |                                                                   解释                                                                   |
| :------: | :-------------------: | :------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: |
|  ubuntu  |         latest        | docker pull ubuntu <br /> **- 等同于 -** <br /> docker pull ubuntu:latest | 此命令将拉取"ubuntu"镜像的最新版本。 如果未指定标签，Docker将假定您需要"latest"版本（如果未指定标签）。<br />值得记住的是，您并不总是需要"latest"。 这个镜像字面上是"最新的"，因为它将包含最近的更改。 这可能会修复或破坏您的容器。 |
...
此插图显示了使用 Docker Compose 与 Docker 部署容器的方式： Docker：
